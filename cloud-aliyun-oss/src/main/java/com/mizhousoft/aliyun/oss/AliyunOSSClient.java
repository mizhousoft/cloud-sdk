...
public class AliyunOSSClient implements OSSClient
{
	...
	{
		if (ossProfile instanceof AliyunOSSProfile profile)
		{
			AliyunBucketStroageServiceImpl bucketService = new AliyunBucketStroageServiceImpl();
			bucketService.init(ossProfile.getBucketName(), profile, cdnProfile);
		...
		{
			throw new CloudSDKException("OSSProfile is not AliyunOSSProfile.");
		}
	}
